...
def visualize(img,labels,bboxes,keypoints,keypoint_option=False,text_option=False):
    image=img
        ...
        for kps in keypoints:
            for idx, kp in enumerate(kps):
                ...
                if text_option:
                    ...
                    image = cv2.putText(image.copy(), " " + str(idx), tuple(kp), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 3, cv2.LINE_AA)
